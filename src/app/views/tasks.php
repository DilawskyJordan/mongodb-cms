...
<head>
  ...
  <title><? echo $websitename; ?> - Tasks</title>
...
<body id="page-top">
  ...
  <div class="row">
    ...
    <div class="col-sm">
      ...
      <? endif; ?>
    <form method="POST" action="<? echo $this->url('postTask'); ?>">
                <input name="_token" value="<? echo $token; ?>" hidden>
                <div class="input-group mb-3" style="width: 100%;">
                  <input type="text" name="title" class="form-control" placeholder="New task!" aria-label="Recipient's username" aria-describedby="button-addon2">
        ...
        <div class="col-6 col-md-4">
                ...
                <? foreach($tasks as $task): ?>
                    <div class="card" style="width: 18rem;">
                      <div class="card-body">
                        <h5 class="card-title"><? echo $task->date; ?></h5>
                        <h6 class="card-subtitle mb-2 text-muted"><? echo $task->title; ?></h6>
                        <form method="POST" action="<? echo $this->url("deleteTask") ?>">
                          <input type="hidden" name="_token" value="<? echo $token; ?>">
                          <input type="hidden" name="id" value="<? echo $task->_id; ?>" >
                          <button type="submit" class="btn btn-link">Done (Delete)</button>
                        </form>
                      </div>
                    </div>
                  <br/>
