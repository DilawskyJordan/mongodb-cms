...
<head>
  ...
  <title><? echo $websitename; ?> - Edit environment file</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Edit environment file</li>
        </ol>
    ...
    <form method="POST" action="<? echo $this->url('postDotenv') ?>">
      <input type="hidden" name="_token" value="<? echo $token; ?>">
      <div class="form-group row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Firstname:</label>
        <div class="col-sm-10">
          <input type="text" name="firstname" class="form-control" id="inputPassword" placeholder="Firstname" value="<? echo $firstname; ?>" required="true">
        </div>
    </div>
    <div class="form-group row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Lastname:</label>
        <div class="col-sm-10">
          <input type="text" name="lastname" class="form-control" id="inputPassword" placeholder="Lastname" value="<? echo $lastname; ?>" required="true">
        </div>
    </div>
    <div class="form-group row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Email:</label>
        <div class="col-sm-10">
          <input type="email" name="email" class="form-control" id="inputPassword" placeholder="Email" value="<? echo $email; ?>" required="true">
        </div>
    </div>
    <div class="form-group row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Website name:</label>
        <div class="col-sm-10">
          <input type="text" name="websitename" class="form-control" id="inputPassword" placeholder="Website name" value="<? echo $websitename; ?>" required="true">
        </div>
    </div>
    <div class="form-group row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Website description:</label>
        <div class="col-sm-10">
          <input type="text" name="description" class="form-control" id="inputPassword" placeholder="Website description" value="<? echo $description; ?>" required="true">
        </div>
    </div>
    ...
    <form method="POST" action="<? echo $this->url('changePassword') ?>">
    <input type="hidden" name="_token" value="<? echo $token; ?>">
      <div class="form-group row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Current password:</label>
        <div class="col-sm-10">
          <input type="password" name="currentPassword" class="form-control" id="inputPassword" placeholder="current password" required="true">
        </div>
    </div>
    <div class="form-group row">
        <label for="inputPassword" class="col-sm-2 col-form-label">New password:</label>
        <div class="col-sm-10">
          <input type="password" name="newPassword" class="form-control" id="inputPassword" placeholder="New password password" required="true">
        </div>
    </div>
