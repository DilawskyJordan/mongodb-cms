...
<head>
  ...
  <title><? echo $websitename; ?> - Change cover</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Change cover and favicon</li>
        </ol>
    ...
    <div class="row">
      ...
      <div class="col-sm" style="max-width: 108%;">
        <? if(isset($errors)) : ?>
      ...
      The current webiste cover :
    </div>
    <img style="width: 100%;" src="<? echo $this->url('src/app/views/images/banner.jpg'); ?>">
    <br/>
    <br/>
    <br/>
    <div class="alert alert-secondary" role="alert">
<label for="exampleFormControlFile1">Upload new one : (When upload refresh this page to see the results)</label>
          <form enctype="multipart/form-data" method="POST" action="<? echo $this->url('postChangeCover') ?>">
                <div class="form-group">
                <input type="hidden" name="_token" value="<? echo $token; ?>">
            <input name="cover" type="file" class="form-control-file" id="exampleFormControlFile1" required="true">
            <br/>
        ...
        <div class="alert alert-primary" role="alert">
        The current webiste favicon :
      </div>
      <img src="<? echo $this->url('src/app/views/images/superLight.png') ?>" alt="">
      <form enctype="multipart/form-data" method="POST" action="<? echo $this->url('postChangeFavicon') ?>">
            <div class="form-group">
            <input type="hidden" name="_token" value="<? echo $token; ?>">
        <input name="cover" type="file" class="form-control-file" id="exampleFormControlFile1" required="true">
        <br/>
